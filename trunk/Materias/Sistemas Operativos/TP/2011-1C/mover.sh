...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fso-bash-beneficios%2Fsource%2Fbrowse%2Ftrunk%2Finst%2Fmover.sh" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/so-bash-beneficios/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/so-bash-beneficios/source/browse/trunk/inst/">inst</a><span class="sp">/&nbsp;</span>mover.sh</span>
 ...
 <a href="/p/so-bash-beneficios/source/browse/trunk/inst/mover.sh?edit=1"
 ...
 <li><a href="/p/so-bash-beneficios/source/browse/trunk/inst/mover.sh?r=4" title="Previous">&lsaquo;r4</a></li>
...
><td class="source"># Nombre:      mover.sh<br></td></tr
><tr
id=sl_svn6_5
...
><td class="source"># Descripcion: Provee la funcionalidad de mover archivos &lt;&lt;inteligentemente&gt;&gt;<br></td></tr
><tr
id=sl_svn6_8

 onmouseover="gutterOver(8)"

><td class="source">#              renombrando y numerando archivos en sub directorios destinados <br></td></tr
><tr
id=sl_svn6_9

 onmouseover="gutterOver(9)"

><td class="source">#              a almacenar archivos duplicados en caso de que los archivos<br></td></tr
><tr
id=sl_svn6_10

 onmouseover="gutterOver(10)"

><td class="source">#              a mover existan<br></td></tr
><tr
id=sl_svn6_11
...
><td class="source"># ./mover.sh &lt;&lt;ARCHIVO ORIGEN&gt;&gt; &lt;&lt;ARCHIVO DESTINO&gt;&gt; [&lt;&lt;COMANDO&gt;&gt;]<br></td></tr
><tr
id=sl_svn6_17
...
><td class="source"># Donde &lt;&lt;ARCHIVO ORIGEN&gt;&gt; es el nombre del archivo origen a mover con<br></td></tr
><tr
id=sl_svn6_19

 onmouseover="gutterOver(19)"

><td class="source"># el script mover.sh<br></td></tr
><tr
id=sl_svn6_20
...
><td class="source"># Donde &lt;&lt;ARCHIVO DESTINO&gt;&gt; es el nombre del archivo destino a mover con<br></td></tr
><tr
id=sl_svn6_22
...
><td class="source"># Donde &lt;&lt;COMANDO&gt;&gt; es el nombre del comando a ser  ejecutado por el<br></td></tr
><tr
id=sl_svn6_25

 onmouseover="gutterOver(25)"

><td class="source"># script mover.sh<br></td></tr
><tr
id=sl_svn6_26
...
><td class="source"># 1) ARCHIVO ORIGEN<br></td></tr
><tr
id=sl_svn6_32

 onmouseover="gutterOver(32)"

><td class="source"># 2) ARCHIVO DESTINO<br></td></tr
><tr
id=sl_svn6_33
...
><td class="source">	. gralog.sh &quot;MOVER&quot; &quot;Error#1: Cantidad invalida de argumentos&quot; &quot;F&quot;<br></td></tr
><tr
id=sl_svn6_37
...
><td class="source"># Obtengo parametro archivo origen<br></td></tr
><tr
id=sl_svn6_42
...
><td class="source">archivoOrigen=$1<br></td></tr
><tr
id=sl_svn6_44
...
><td class="source"># Obtengo parametro archivo destino<br></td></tr
><tr
id=sl_svn6_47
...
><td class="source">archivoDestino=$2<br></td></tr
><tr
id=sl_svn6_49
...
><td class="source"># Valido la existencia del archivo de origen<br></td></tr
><tr
id=sl_svn6_52
...
><td class="source">if [ -f $archivoOrigen ]<br></td></tr
><tr
id=sl_svn6_54
...
><td class="source">	# Verifico si directorio destino existe<br></td></tr
><tr
id=sl_svn6_57
...
><td class="source">	if [  -d $archivoDestino ]<br></td></tr
><tr
id=sl_svn6_59
...
><td class="source">		# Obtengo nombre de archivo de origen<br></td></tr
><tr
id=sl_svn6_63
...
><td class="source">		nombreArchivoOrigen=`basename $archivoOrigen`<br></td></tr
><tr
id=sl_svn6_65
...
><td class="source">		# Obtengo archvivo de destino<br></td></tr
><tr
id=sl_svn6_68
...
><td class="source">		archivoDestino=&quot;$archivoDestino/$nombreArchivoOrigen&quot;<br></td></tr
><tr
id=sl_svn6_70
...
><td class="source">	# Valido la existencia del archivo de destino<br></td></tr
><tr
id=sl_svn6_74
...
><td class="source">	if [ -f $archivoDestino ]<br></td></tr
><tr
id=sl_svn6_76
...
><td class="source">		# Verifico si segundo argumento es un directorio<br></td></tr
><tr
id=sl_svn6_79
...
><td class="source">		# Obtengo el directorio de destino<br></td></tr
><tr
id=sl_svn6_95
...
><td class="source">		directorioDestino=`dirname $archivoDestino`<br></td></tr
><tr
id=sl_svn6_97
...
><td class="source">		# Obtengo el nombre del archivo de destino<br></td></tr
><tr
id=sl_svn6_100
...
><td class="source">		nombreArchivoDestino=`basename $archivoDestino`<br></td></tr
><tr
id=sl_svn6_102
...
><td class="source">		# Obtengo el directorio de destino duplicado<br></td></tr
><tr
id=sl_svn6_105
...
><td class="source">		directorioDestinoDuplicado=&quot;$directorioDestino/dup&quot;<br></td></tr
><tr
id=sl_svn6_107
...
><td class="source">		# Verifico existencia de directorio destino duplicado<br></td></tr
><tr
id=sl_svn6_110
...
><td class="source">		if [ ! -d $directorioDestinoDuplicado ]<br></td></tr
><tr
id=sl_svn6_112
...
><td class="source">			mkdir -p &quot;$directorioDestinoDuplicado&quot;<br></td></tr
><tr
id=sl_svn6_114
...
><td class="source">		# Defino version<br></td></tr
><tr
id=sl_svn6_118
...
><td class="source">		version=&quot;1&quot;<br></td></tr
><tr
id=sl_svn6_120
...
><td class="source">		# Nomre de archivo duplicado<br></td></tr
><tr
id=sl_svn6_123
...
><td class="source">		archivoDuplicado=&quot;$directorioDestinoDuplicado/$nombreArchivoDestino.$version&quot;<br></td></tr
><tr
id=sl_svn6_125
...
><td class="source">		while [ -f $archivoDuplicado ]<br></td></tr
><tr
id=sl_svn6_127
...
><td class="source">			version=`expr $version + 1`<br></td></tr
><tr
id=sl_svn6_129
...
><td class="source">		# Obtengo archivoDestino<br></td></tr
><tr
id=sl_svn6_134
...
><td class="source">		archivoDestino=$archivoDuplicado<br></td></tr
><tr
id=sl_svn6_136
...
><td class="source">		mv &quot;$archivoOrigen&quot; &quot;$archivoDestino&quot; 2&gt;/dev/null<br></td></tr
><tr
id=sl_svn6_138
...
><td class="source">		# Verifico valor de retorno del comando mv<br></td></tr
><tr
id=sl_svn6_141
...
><td class="source">		if [ $? -eq 0 ]<br></td></tr
><tr
id=sl_svn6_143
...
><td class="source">			. gralog.sh &quot;MOVER&quot; &quot;Mover archivo duplicado. El archivo $archivoOrigen ha sido movido a $archivoDestino&quot; &quot;W&quot;<br></td></tr
><tr
id=sl_svn6_145
...
><td class="source">			. gralog.sh &quot;MOVER&quot; &quot;Error al mover el archivo duplicado desde $archivoOrigen al destino $archivoDestino&quot; &quot;F&quot;<br></td></tr
><tr
id=sl_svn6_147
...
><td class="source">			. gralog.sh &quot;MOVER&quot; &quot;El archivo $archivoOrigen ha sido movido a $archivoDestino&quot; &quot;I&quot;<br></td></tr
><tr
id=sl_svn6_157
...
><td class="source">			. gralog.sh &quot;MOVER&quot; &quot;Error al mover el archivo desde $archivoOrigen al destino $archivoDestino&quot; &quot;F&quot;<br></td></tr
><tr
id=sl_svn6_159
...
><td class="source">	. gralog.sh &quot;MOVER&quot; &quot;El archivo $archivoOrigen es inexistente&quot; &quot;F&quot;<br></td></tr
><tr
id=sl_svn6_164
...
<script type="text/javascript">
 ...
 &nbsp; <a href="/p/so-bash-beneficios/source/diff?spec=svn6&r=5&amp;format=side&amp;path=/trunk/inst/mover.sh&amp;old_path=/trunk/inst/mover.sh&amp;old=4">Diff</a>
 </div>
...
documentacion y uso de log en start y stop
 ...
 var selected_path = '/trunk/inst/mover.sh';
 ...
 <a href="/p/so-bash-beneficios/source/detail?spec=svn6&r=4">r4</a>
 by pmviva
 on Apr 19 (4 days ago)
 &nbsp; <a href="/p/so-bash-beneficios/source/diff?spec=svn6&r=4&amp;format=side&amp;path=/trunk/inst/mover.sh&amp;old_path=/trunk/inst/mover.sh&amp;old=0">Diff</a>
 <br>
 <pre class="ifOpened">Commit del script de mover mover.sh
que detecta copias de archivos
duplicados y numera secuencialmente
las copias, detecta si el destino del
movimiento es un directorio, y si este
...</pre>
 </div>
 
 
 <a href="/p/so-bash-beneficios/source/list?path=/trunk/inst/mover.sh&start=5">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="http://so-bash-beneficios.googlecode.com/svn/trunk/inst/mover.sh">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn6': '/trunk/inst/mover.sh'}
