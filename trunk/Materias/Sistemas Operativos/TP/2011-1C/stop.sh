...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=http%3A%2F%2Fcode.google.com%2Fp%2Fso-bash-beneficios%2Fsource%2Fbrowse%2Ftrunk%2Finst%2Fstop.sh" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/so-bash-beneficios/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/so-bash-beneficios/source/browse/trunk/inst/">inst</a><span class="sp">/&nbsp;</span>stop.sh</span>
 ...
 <a href="/p/so-bash-beneficios/source/browse/trunk/inst/stop.sh?edit=1"
 ...
 <li><a href="/p/so-bash-beneficios/source/browse/trunk/inst/stop.sh?r=2" title="Previous">&lsaquo;r2</a></li>
...
><td class="source"># Nombre:      stop.sh<br></td></tr
><tr
id=sl_svn6_5
...
><td class="source"># Descripcion: Provee la funcionalidad de parar comandos<br></td></tr
><tr
id=sl_svn6_8
...
><td class="source">#              encuentra en ejecucion y pararlo.<br></td></tr
><tr
id=sl_svn6_10
...
><td class="source"># ./stop.sh &lt;&lt;COMANDO&gt;&gt;<br></td></tr
><tr
id=sl_svn6_16
...
><td class="source"># Donde &lt;&lt;COMANDO&gt;&gt; es el nombre del comando a parar por el script stop.sh<br></td></tr
><tr
id=sl_svn6_18
...
><td class="source">        . gralog.sh &quot;STOP&quot; &quot;Error#1: Cantidad de parametros invalida&quot; &quot;F&quot;<br></td></tr
><tr
id=sl_svn6_26
...
><td class="source">comandoParar=$1<br></td></tr
><tr
id=sl_svn6_33
...
><td class="source"># Obtiene el comando pkill a usar<br></td></tr
><tr
id=sl_svn6_41
...
><td class="source">comandoPkill=`which pkill`<br></td></tr
><tr
id=sl_svn6_43
...
><td class="source">        . gralog.sh &quot;STOP&quot; &quot;Error#2: El comando pgrep no se encuentra en el PATH de ejecucion&quot; &quot;F&quot;<br></td></tr
><tr
id=sl_svn6_50
...
><td class="source"># Verifica si el comando pkill existe en el PATH en caso contrario aborta<br></td></tr
><tr
id=sl_svn6_55
...
><td class="source">if [ ! -f $comandoPkill ]<br></td></tr
><tr
id=sl_svn6_57
...
><td class="source">	. gralog.sh &quot;STOP&quot; &quot;Error#3: El comando pkill no se encuentra en el PATH de ejecucion&quot; &quot;F&quot;<br></td></tr
><tr
id=sl_svn6_59
...
><td class="source"># Obtiene el PID del comando a parar<br></td></tr
><tr
id=sl_svn6_64
...
><td class="source">pid=`$comandoPgrep $comandoParar`<br></td></tr
><tr
id=sl_svn6_66
...
><td class="source"># Verifica si el comando a parar ya se encuentra en ejecucion y lo para<br></td></tr
><tr
id=sl_svn6_69
...
><td class="source">        . gralog.sh &quot;STOP&quot; &quot;Parando comando $comandoParar con process id $pid&quot; &quot;I&quot;<br></td></tr
><tr
id=sl_svn6_73

 onmouseover="gutterOver(73)"

><td class="source">         $comandoPkill -KILL $comandoParar<br></td></tr
><tr
id=sl_svn6_74
...
><td class="source">	if [ $? -ne 0 ]<br></td></tr
><tr
id=sl_svn6_76
...
><td class="source">		. gralog.sh &quot;STOP&quot; &quot;Error#4 Error parando el comando $comandoParar con process id $pid&quot; &quot;I&quot;<br></td></tr
><tr
id=sl_svn6_78
...
><td class="source">        . gralog.sh &quot;STOP&quot; &quot;Programa $comandoParar no se encuentra en ejecucion&quot; &quot;W&quot;<br></td></tr
><tr
id=sl_svn6_81
...
<script type="text/javascript">
 ...
 &nbsp; <a href="/p/so-bash-beneficios/source/diff?spec=svn6&r=5&amp;format=side&amp;path=/trunk/inst/stop.sh&amp;old_path=/trunk/inst/stop.sh&amp;old=2">Diff</a>
 </div>
...
documentacion y uso de log en start y stop
 ...
 var selected_path = '/trunk/inst/stop.sh';
 ...
 &nbsp; <a href="/p/so-bash-beneficios/source/diff?spec=svn6&r=2&amp;format=side&amp;path=/trunk/inst/stop.sh&amp;old_path=/trunk/inst/stop.sh&amp;old=0">Diff</a>
 <br>
...
inician y paran procesos en bash</pre>
 ...
 <a href="/p/so-bash-beneficios/source/list?path=/trunk/inst/stop.sh&start=5">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="http://so-bash-beneficios.googlecode.com/svn/trunk/inst/stop.sh">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn6': '/trunk/inst/stop.sh'}
